...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key)) {
        ...
        const latestTransactionsPromise = Order.find({})
            ...
            .limit(4);
        const [thisMonthProducts, thisMonthUsers, thisMonthOrders, lastMonthProducts, lastMonthUsers, lastMonthOrders, ProductCount, UserCount, allOrder, lastSixMonthOrders, categories, femaleUsersCount, latestTransaction,] = await Promise.all([
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has(key)) {
        ...
        const [ProcessingOrder, Shippedorder, deliveredOrder, categories, ProductCount, OutOfStack, allOrders, allUsers, adminUsers, customerUsers,] = await Promise.all([
